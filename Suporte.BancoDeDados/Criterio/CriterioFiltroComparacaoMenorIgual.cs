...
namespace Suporte.BancoDeDados.Criterio
{
    ...
    /// <para>Utiliza o operador de comparação: &lt;= (menor igual que)</para>
    /// </summary>
    public class CriterioFiltroComparacaoMenorIgual : CriterioFiltroComparacao
    {
        /// <summary>
        ...
        /// </param>
        public CriterioFiltroComparacaoMenorIgual(ICampoDeBancoDeDados campo, object valor) : base("<=", campo, valor) { }
    }
}
