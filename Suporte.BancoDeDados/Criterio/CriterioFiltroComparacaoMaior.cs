...
namespace Suporte.BancoDeDados.Criterio
{
    ...
    /// <para>Utiliza o operador de comparação: %gt; (maior que)</para>
    /// </summary>
    public class CriterioFiltroComparacaoMaior : CriterioFiltroComparacao
    {
        /// <summary>
        ...
        /// </param>
        public CriterioFiltroComparacaoMaior(ICampoDeBancoDeDados campo, object valor) : base(">", campo, valor) { }
    }
}
