...
namespace Suporte.Texto.FormatProvider
{
    ...
    /// fiquem em minúsculo.</para>
    /// </summary>
    public class FormatadorTransformaParaMinusculo : FormatadorTransparente
    {
        /// <summary>
        /// <para>Construtor.</para>
        /// </summary>
        public FormatadorTransformaParaMinusculo() : base() { }

        /// <summary>
        /// <para>Construtor.</para>
        /// </summary>
        /// <param name="formatProvider"><para>Decora um FormatProvider já existente.</para></param>
        public FormatadorTransformaParaMinusculo(IFormatProvider formatProvider) : base(formatProvider) { }
        ...
        {
            return base.Format(format, arg, formatProvider).ToLower();
        }
