...
namespace Suporte.Controles.MDI.WPF
{
    ...
    public class MdiContainer : UserControl
    {
        ...
        /// <summary>
        /// Identifies the Suporte.Controles.MDI.WPF.MdiContainer.Theme dependency property.
        /// </summary>
        /// <returns>The identifier for the Suporte.Controles.MDI.WPF.MdiContainer.Theme property.</returns>
        ...
        /// TODOs: Look into how ZIndex works.
        /// </summary>
        ...
        private static void ThemeValueChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                case ThemeType.Luna:
                    Application.Current.Resources.MergedDictionaries.Add(currentResourceDictionary = (ResourceDictionary)XamlReader.Load(Application.GetResourceStream(new Uri(@"Suporte.Controles.MDI.WPF;component/Themes/Luna.xaml", UriKind.Relative)).Stream));
                    break;
                case ThemeType.Aero:
                    Application.Current.Resources.MergedDictionaries.Add(currentResourceDictionary = (ResourceDictionary)XamlReader.Load(Application.GetResourceStream(new Uri(@"Suporte.Controles.MDI.WPF;component/Themes/Aero.xaml", UriKind.Relative)).Stream));
                    break;
            }
        }
